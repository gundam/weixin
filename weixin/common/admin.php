<?php 
	...
	if ($action=='addFood') {
			$id=$sql->get_total_number("wx_food")+1;
			$wx_food_name  =$_REQUEST['wx_food_name'];
			$wx_food_belong  =$_REQUEST['wx_food_belong'];
			$wx_food_price  =$_REQUEST['wx_food_price'];
			$wx_food_type =$_REQUEST['wx_food_type'];
			//$wx_food_img  =$_REQUEST['wx_food_img'];

			$data=array("wx_food_id"=>"3".$id,"wx_food_name"=>$wx_food_name,"wx_food_belong"=>$wx_food_belong,"wx_food_price"=>$wx_food_price,"wx_food_type"=>$wx_food_type);
			echo $sql->insert("wx_food",$data);
